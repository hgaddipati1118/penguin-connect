...
class AppHttpIntegrationTests(unittest.TestCase):
    ...
    def test_ui_endpoint_serves_console_assets(self):
        ...
        self.assertIn('key === "y" && focusedLoadedMessage()', js_response.text)
        self.assertIn('key === "d" && focusedLoadedMessage()', js_response.text)
        self.assertIn('key === "s" && focusedLoadedMessage()', js_response.text)
        self.assertIn('key === "u" && focusedLoadedMessage()', js_response.text)
        self.assertIn('key === "e" && focusedLoadedMessage()', js_response.text)
        self.assertIn('key === "m" && state.selected', js_response.text)
        self.assertIn('key === "." && state.selected', js_response.text)
        ...
        self.assertIn('key === "ArrowDown" || key === "j"', js_response.text)
        self.assertIn('key === "ArrowUp" || key === "k"', js_response.text)
