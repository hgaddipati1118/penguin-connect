...
class AppHttpIntegrationTests(unittest.TestCase):
    ...
    def test_ui_endpoint_serves_console_assets(self):
        ...
        self.assertEqual(inbox_response.headers["cache-control"], "no-store")
        ...
        self.assertNotIn("dataset.renderFingerprint", inbox_js_response.text)
        self.assertIn('el.messageList.addEventListener("click", handleMessageListAction)', inbox_js_response.text)
        self.assertNotIn('pin.addEventListener("click"', inbox_js_response.text)
        self.assertNotIn('translate.addEventListener("click"', inbox_js_response.text)
        self.assertNotIn('react.addEventListener("click"', inbox_js_response.text)
        self.assertNotIn('reply.addEventListener("click"', inbox_js_response.text)
        ...
        self.assertIn("const slackChanged =", inbox_js_response.text)
        self.assertIn('selectedProvider === "slack" && slackChanged', inbox_js_response.text)
        ...
        self.assertIn("queueThreadBottomAnchor", inbox_js_response.text)
        self.assertIn("latestAnchorResizeObserver", inbox_js_response.text)
        self.assertIn("NATIVE_SCROLL_ANCHORING", inbox_js_response.text)
        self.assertIn("thread-bottom-anchor", inbox_js_response.text)
        self.assertIn(".thread-bottom-anchor", inbox_css_response.text)
        self.assertIn("slackThreadRenderRows", inbox_js_response.text)
        self.assertIn("nativeReplyDepth", inbox_js_response.text)
        self.assertIn("message-native-reply", inbox_js_response.text)
        self.assertIn("replyDepth", inbox_js_response.text)
        self.assertIn("slackMessageAuthor", inbox_js_response.text)
        self.assertIn("slackThreadIsCollapsed", inbox_js_response.text)
        self.assertIn("applySlackThreadDefaults", inbox_js_response.text)
        self.assertIn("expandedSlackThreads", inbox_js_response.text)
        self.assertIn("message-thread-latest", inbox_js_response.text)
        ...
        self.assertIn("buildMessageReplyTarget", thread_layout_js_response.text)
        self.assertIn("planNativeReplySummaries", thread_layout_js_response.text)
        self.assertIn("providerSupportsReply", thread_layout_js_response.text)
        self.assertIn("jump-native-replies", inbox_js_response.text)
        self.assertIn("Replying with local context", inbox_js_response.text)
        self.assertIn('["slack", "whatsapp", "imessage"]', inbox_js_response.text)
        self.assertIn("setFocusedMessage", inbox_js_response.text)
        self.assertIn("state.focusedMessageId", inbox_js_response.text)
        self.assertIn('"slack", "whatsapp"', inbox_js_response.text)
        self.assertIn("clearReplyTarget", inbox_js_response.text)
        self.assertIn("reply_to_message_id", inbox_js_response.text)
        self.assertIn("reply_context_message_id", inbox_js_response.text)
        self.assertIn("replyTargetProviderMessageId", inbox_js_response.text)
        self.assertIn("buildSlackReplyTarget", inbox_js_response.text)
        self.assertIn("reply_context", inbox_js_response.text)
        self.assertIn("composerReplyContext", inbox_response.text)
        self.assertIn("message-thread-reply", inbox_css_response.text)
        self.assertIn(".message-row.message-focused", inbox_css_response.text)
        self.assertIn("message-reply-button", inbox_css_response.text)
        self.assertIn("replyable-message", inbox_js_response.text)
        self.assertIn(".message-row.replyable-message .message-reply-button", inbox_css_response.text)
        self.assertIn("Reply to ${replyRecipient} in thread", inbox_js_response.text)
        self.assertIn("captureUnreadBoundary", inbox_js_response.text)
        self.assertIn('unreadDivider.className = "unread-divider"', inbox_js_response.text)
        self.assertIn("focusedThreadId || unreadThreadId", inbox_js_response.text)
        self.assertIn(".unread-divider", inbox_css_response.text)
        self.assertIn("firstUnreadMessageId", thread_layout_js_response.text)
        self.assertIn("message-reply-quote", inbox_css_response.text)
        self.assertIn(".message-row.message-native-reply", inbox_css_response.text)
        self.assertIn(".message-native-reply-count:focus-visible", inbox_css_response.text)
        self.assertIn("message-thread-actions", inbox_css_response.text)
        self.assertIn(".message-thread-summary.collapsed", inbox_css_response.text)
        self.assertIn(".message-thread-latest", inbox_css_response.text)
        self.assertIn("message-thread-reply-cta", inbox_css_response.text)
        self.assertIn('data-message-operation="note"', inbox_response.text)
        self.assertIn('id="messageNoteDialog"', inbox_response.text)
        self.assertIn("openMessageNoteDialog", inbox_js_response.text)
        self.assertIn("submitMessageNote", inbox_js_response.text)
        self.assertIn("message-local-note", inbox_js_response.text)
        self.assertIn(".message-local-note", inbox_css_response.text)
        self.assertIn('key === "n"', inbox_js_response.text)
        self.assertNotIn("Date.now() - startedAt < durationMs", inbox_js_response.text)
        self.assertNotIn("durationMs", inbox_js_response.text)
        self.assertIn("LATEST_ANCHOR_OBSERVER_MS = 1600", inbox_js_response.text)
        ...
        self.assertIn("!state.contactsDetailed", inbox_js_response.text)
        self.assertIn("loadDetailedContacts", inbox_js_response.text)
        self.assertIn("include_counts=false&include_thread_stats=false", inbox_js_response.text)
        ...
        self.assertIn("WORKSPACE_CACHE_THREAD_LIMIT = 160", inbox_js_response.text)
        self.assertIn("PRELOAD_EAGER_THREAD_LIMIT = 48", inbox_js_response.text)
        ...
        self.assertIn("restoreConversationDraft", inbox_js_response.text)
        self.assertIn("clearConversationDraft", inbox_js_response.text)
        self.assertIn("queueConversationDraftServerWrite", inbox_js_response.text)
        ...
        self.assertIn("latestOwnMessageId", inbox_js_response.text)
