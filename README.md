...
selected-thread participants, copyable/searchable recent contact history with thread filters, click-to-draft contact starts, contact-to-new-chat recipient picking with visible-result bulk add/copy/save actions,
...
rail-level pin/mute/archive/read-unread actions, follow-up scheduling/filtering with quick presets from threads or message rows plus bulk follow-up set/clear, read/unread management, bridge
