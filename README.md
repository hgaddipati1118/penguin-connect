...
thread-name and local-management-aware contact/participant search with highlighted related-thread label/note context, private contact notes with note-aware search, contact creation, contact-to-thread matching, saved-contact resolution for
