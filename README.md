...
rail-level pin/mute/archive/read-unread actions, follow-up scheduling/filtering with quick presets plus bulk follow-up set/clear, read/unread management, bridge
