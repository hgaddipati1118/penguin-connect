...
for local audio attachments, highlighted cached Contacts search/refresh with saved/unsaved/threaded/favorite/noted
source filters with counts, contact thread activity metadata, contact sorting including threads-first triage, saved contact-search views, all/saved/unsaved contact browsing, conversation-participant fallback and related-thread shortcuts with unread/source context,
