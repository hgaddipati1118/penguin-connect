...
thread-name, cached-message, and local-management-aware contact/participant search with highlighted related-thread label/note context and contact-to-thread rail filtering, private contact notes with note-aware search, contact creation, contact-to-thread matching, saved-contact resolution for
