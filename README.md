...
message notes, per-message read/unread toggles, visible loaded-message bulk star/read/unread actions, opening synced attachment files, a per-thread media browser for loaded
