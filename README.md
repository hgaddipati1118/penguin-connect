...
source filters with counts, contact sorting including threads-first triage, saved contact-search views, all/saved/unsaved contact browsing, conversation-participant fallback and related-thread shortcuts with unread/source context,
