...
source filters with counts, contact thread and unread activity metadata, contact sorting including unread-first and threads-first triage, saved contact-search views, all/saved/unsaved contact browsing, conversation-participant fallback and related-thread shortcuts with unread/source context,
