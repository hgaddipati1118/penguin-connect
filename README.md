...
search/refresh, contact creation, contact-to-thread matching, new chat draft
staging, and a Codex prompt helper that copies recent thread context plus your
