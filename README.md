...
for local audio attachments, highlighted cached Contacts search/refresh with saved/unsaved/threaded/unread/needs-reply/follow-up/favorite/noted
source filters with counts, contact thread, needs-reply, follow-up, and unread activity metadata, contact sorting including needs-reply-first, follow-up-first, unread-first, and threads-first triage, saved contact-search views, all/saved/unsaved contact browsing, conversation-participant fallback and related-thread shortcuts with unread/source context,
